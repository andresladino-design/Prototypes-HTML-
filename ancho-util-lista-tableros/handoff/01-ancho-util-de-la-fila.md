...
> [`../Add folder organization structure for dashboard list/design-record/01-decisiones.md`](../../Add%20folder%20organization%20structure%20for%20dashboard%20list/design-record/01-decisiones.md).
