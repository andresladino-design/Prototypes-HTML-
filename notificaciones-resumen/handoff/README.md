...
| [`handoff-anomalias-filtros-notificaciones.md`](./handoff-anomalias-filtros-notificaciones.md) | **Vista de Anomalías** (3 épicas, cada cambio de UI enumerado): **Filtros** multiselect (O/Y) + guardados, sin Severidad · **Notificaciones de incidentes = paquetes de reglas** (scope/momento/updates/canales) · **Resumen consolidado** sección propia. Origen: Granola 30-jun + Ohana | `#viewAnomalias`, `#anFMenu`, `.an-fchip`, `#anCfgNotif` (`.an-pkg*`), `#anCfgResumen` |
